# 第 4 课：接入 OpenAI-compatible 模型服务

> 所属章节：[第一章：LLM API、Prompt、Structured Output 与 Gateway](./index.md)  
> 上一课：[第 3 课：用 Provider 抽象隔离模型服务](./lesson-03-provider-abstraction-mock.md)  
> 下一课：[第 5 课：管理 Prompt 模板与版本](./lesson-05-prompt-management.md)  
